...
@pytest.mark.parametrize(
    'smiles, node_data, edge_data, explicit_h',
    (
        (
            'CCCC',
        ...
        (
            '[13CH3-1:1]',
            [(0, {'charge': -1, 'class': 1, 'element': 'C', 'hcount': 3,
                   'isotope': 13, 'aromatic': False})],
            [],
            False
        ),
        (
        ...
        (
            ...
            [(0, {'element': 'C', 'charge': 0, 'aromatic': False, 'hcount': 3}),
             (1, {'charge': 0, 'aromatic': False, 'element': 'C',
                  'rs_isomer': (0, 1, 5, 2), 'hcount': 1}),
        ...
        (r'F\C=C\F',
            [(0, {'element': 'F', 'charge': 0, 'aromatic': False, 'hcount': 0,
                   'ez_isomer': [(0, 1, 2, 3, 'trans')]}),
             (1, {'element': 'C', 'charge': 0, 'aromatic': False, 'hcount': 1}),
             (2, {'element': 'C', 'charge': 0, 'aromatic': False, 'hcount': 1}),
             (3, {'element': 'F', 'charge': 0, 'aromatic': False, 'hcount': 0,
                   'ez_isomer': [(3, 2, 1, 0, 'trans')]}),],
            [(0, 1, {'order': 1}),
             (1, 2, {'order': 2}),
             (2, 3, {'order': 1}),],
            False,
        ...
        (r'C(/F)=C\F',
            [(0, {'element': 'C', 'charge': 0, 'aromatic': False, 'hcount': 1}),
             (1, {'element': 'F', 'charge': 0, 'aromatic': False, 'hcount': 0,
                   'ez_isomer': [(1, 0, 2, 3, 'trans')]}),
             (2, {'element': 'C', 'charge': 0, 'aromatic': False, 'hcount': 1}),
             (3, {'element': 'F', 'charge': 0, 'aromatic': False, 'hcount': 0,
                   'ez_isomer': [(3, 2, 0, 1, 'trans')]}),],
            [(0, 1, {'order': 1}),
             (0, 2, {'order': 2}),
             (2, 3, {'order': 1}),],
            False,
        ...
        (r'C(\F)=C\F',
            [(0, {'element': 'C', 'charge': 0, 'aromatic': False, 'hcount': 1}),
             (1, {'element': 'F', 'charge': 0, 'aromatic': False, 'hcount': 0,
                   'ez_isomer': [(1, 0, 2, 3, 'cis')]}),
             (2, {'element': 'C', 'charge': 0, 'aromatic': False, 'hcount': 1}),
             (3, {'element': 'F', 'charge': 0, 'aromatic': False, 'hcount': 0,
                   'ez_isomer': [(3, 2, 0, 1, 'cis')]}),],
            [(0, 1, {'order': 1}),
             (0, 2, {'order': 2}),
             (2, 3, {'order': 1}),],
            False,
...
@pytest.mark.parametrize('smiles, records', [
    (r'F/C=C/F',
     [[(0, 1, 2, 3, 'trans')], [(3, 2, 1, 0, 'trans')]]),
    (r'C(\F)=C/F',
     [[(1, 0, 2, 3, 'trans')], [(3, 2, 0, 1, 'trans')]]),
    (r'F\C=C/F',
     [[(0, 1, 2, 3, 'cis')], [(3, 2, 1, 0, 'cis')]]),
    (r'C(/F)=C/F',
     [[(1, 0, 2, 3, 'cis')], [(3, 2, 0, 1, 'cis')]]),
    (r'F/C(CC)=C/F',
     [[(0, 1, 4, 5, 'trans')], [(5, 4, 1, 0, 'trans')]]),
    (r'F/C(/F)=C(/F)',
     [[(0, 1, 3, 4, 'trans')],
      [(2, 1, 3, 4, 'cis')],
      [(4, 3, 1, 0, 'trans'), (4, 3, 1, 2, 'cis')]]),
...
@pytest.mark.parametrize('smiles', [
    ...
    ('c12c3c4c5c6c3c3c7c1c1c8c9c%10c(c82)c4c2c5c4c5c6c6c8c%11c%12c%13c%14c%11c'
     '(c7c7c1c1c9c9c%11c%10c2c2c4c(c85)c%12c(c2%11)c%13c9c1c%147)c63'),  # C50 fullerene, 40s
    ('C12=C3C4=C5C1=C1C6=C7C2=C2C8=C3C3=C9C4=C4C%10=C5C5=C1C1=C6C6=C%11C7=C2C2'
     '=C7C8=C3C3=C8C9=C4C4=C9C%10=C5C5=C1C1=C6C6=C%11C2=C2C7=C3C3=C8C4=C4C9=C5C1=C1C6=C2C3=C14'),  # C60 fullerene
])
